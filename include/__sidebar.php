    ...
    <aside>
        <ul id="manage">
            ...
            <li class="sidebar-item">
                <a href="#">雪場管理</a>   
                <div class="submenu">
                    <a class="submenu-sidebar-item" href="#">雪場資訊管理</a>
                    <a class="submenu-sidebar-item" href="#">教練管理</a>
                    <a class="submenu-sidebar-item" href="#">雪具租借管理</a>
                    <a class="submenu-sidebar-item" href="#">飯店管理</a>
                </div>
            </li>
            <li class="sidebar-item"><a href="#">品牌廠商管理</a></li>
            <li class="sidebar-item"><a href="#">景點管理</a></li>
            <li class="sidebar-item"><a href="#">訂單管理</a></li> 
            <li class="sidebar-item"><a href="#">廠商基本資料</a></li>
        </ul>
    </aside>
</div> -->
...
<link rel="stylesheet" href="css/sidebar.css">
    <aside>
        <ul id="manage">
            ...
            <li class="sidebar-item"><a href="#">教練管理
            <div class="sidebar-submenu">
                    <a class="submenu-item" href="__coachinsert.php">新增教練</a>
                    <a class="submenu-item" href="__coachlist.php">教練管理</a>
                    </div>
            </a></li>
            <li class="sidebar-item">
                <a href="#">飯店資訊管理
        ...
        <!-- <div class="form">
            <form action="">
                ...
                <label for="">聯絡人<input class="checkbox" type="checkbox">同負責人</label></input><input type="text">
